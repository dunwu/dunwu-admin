...
export function delBatch(ids) {
  return request({
    url: 'mnt/deploy/history/del/batch',
    method: 'post',
    data: ids
  })
}
...
export function exportList(ids) {
  return request({
    url: 'mnt/deploy/history/export/list',
    method: 'post',
    responseType: 'blob',
    data: ids
  })
...
export function exportPage(params) {
  return request({
    url: 'mnt/deploy/history/export/page',
    method: 'get',
    responseType: 'blob',
    params
  })
