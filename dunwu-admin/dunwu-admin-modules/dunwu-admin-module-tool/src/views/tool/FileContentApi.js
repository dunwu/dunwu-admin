...
export function delBatch(ids) {
  return request({
    url: 'tool/file/content/del/batch',
    method: 'post',
    data: ids
  })
}
...
export function exportList(ids) {
  return request({
    url: 'tool/file/content/export/list',
    method: 'post',
    responseType: 'blob',
    data: ids
  })
...
export function exportPage(params) {
  return request({
    url: 'tool/file/content/export/page',
    method: 'get',
    responseType: 'blob',
    params
  })
