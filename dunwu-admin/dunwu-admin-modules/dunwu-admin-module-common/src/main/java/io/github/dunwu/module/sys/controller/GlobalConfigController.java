...
public class GlobalConfigController {
    ...
    @AppLog(bizType = "系统全局配置表", operType = "添加", value = "'向 sys_global_config 表中添加一条记录，内容为：' + #entity")
    @PostMapping("add")
    ...
    @AppLog(bizType = "系统全局配置表", operType = "批量添加", value = "'向 sys_global_config 表中批量添加 ' + #list.size + ' 条记录'")
    ...
    @AppLog(bizType = "系统全局配置表", operType = "更新", value = "'更新 sys_global_config 表中 id = ' + #entity.id + ' 的记录，内容为：' + #entity")
    @PostMapping("edit")
    ...
    @AppLog(bizType = "系统全局配置表", operType = "批量更新", value = "'批量更新 sys_global_config 表中 ' + #list.size + ' 条记录'")
    ...
    @AppLog(bizType = "系统全局配置表", operType = "删除", value = "'删除 sys_global_config 表中 id = ' + #entity.id + ' 的记录'")
    @PostMapping("del/{id}")
    ...
    @AppLog(bizType = "系统全局配置表", operType = "批量删除", value = "'批量删除 sys_global_config 表中 ' + #list.size + ' 条记录'")
    ...
    @AppLog(bizType = "系统全局配置表", operType = "导出", value = "'导出 sys_global_config 表中 id = ' + #ids + ' 的记录'")
