...
import io.github.dunwu.module.mnt.domain.ServerDeploy;
import io.github.dunwu.module.mnt.repository.DeployRepository;
import io.github.dunwu.module.mnt.service.DeployHistoryService;
import io.github.dunwu.module.mnt.service.DeployService;
import io.github.dunwu.module.mnt.service.ServerDeployService;
...
import io.github.dunwu.module.mnt.service.dto.ServerDeployDto;
import io.github.dunwu.module.mnt.util.ExecuteShellUtil;
import io.github.dunwu.module.mnt.util.ScpClientUtil;
import io.github.dunwu.module.mnt.websocket.MsgType;
import io.github.dunwu.module.mnt.websocket.SocketMsg;
import io.github.dunwu.module.mnt.websocket.WebSocketServer;
import io.github.dunwu.module.mnt.service.mapstruct.DeployMapper;
...
public class DeployServiceImpl implements DeployService {
    ...
    public Object queryAll(DeployQueryCriteria criteria, Pageable pageable) {
        Page<Deploy> page = deployRepository.findAll(
            ...
            pageable);
        return PageUtil.toMap(page.map(deployMapper::toDto));
    }
