...
public class RoleController {
    ...
    @GetMapping(value = "/{id}")
    @PreAuthorize("@exp.check('roles:list')")
    ...
    @PreAuthorize("@exp.check('role:list')")
    ...
    @PreAuthorize("@exp.check('roles:list','user:add','user:edit')")
    ...
    @ApiOperation("新增角色")
    @PostMapping
    @PreAuthorize("@exp.check('roles:add')")
    ...
    @ApiOperation("修改角色")
    @PutMapping
    @PreAuthorize("@exp.check('roles:edit')")
    ...
    @ApiOperation("删除角色")
    @DeleteMapping
    @PreAuthorize("@exp.check('roles:del')")
