...
CREATE TABLE `code_column_config` (
    ...
    `key_type`        VARCHAR(255) DEFAULT NULL COMMENT '字段KEY类型',
    ...
    `enable_query`    BIT(1)       DEFAULT NULL COMMENT '出现在搜索',
    `form_type`       VARCHAR(255) DEFAULT NULL COMMENT '前端表单类型',
    `list_show`       BIT(1)       DEFAULT NULL COMMENT '前端列表类型',
    `query_type`      VARCHAR(255) DEFAULT NULL COMMENT '前端搜索类型',
    `enable_sort`     BIT(1)       DEFAULT NULL COMMENT '是否为排序字段',
